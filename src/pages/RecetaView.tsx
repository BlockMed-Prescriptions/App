            ...
            <IonContent>
                ...
                <div>
                    <IonText className='ion-padding' color="medium">
                        <small>Estado interno: {receta?.estado}.</small>
                    </IonText>
                </div>
                ...
                <IonText className='ion-padding' color="medium">
                    <small>
                        Hash Emisión: {receta?.transactionHashEmision}
                    </small>
                    </IonText>
                </div>) : ''}
                {receta?.transactionHashDispensa ? (
                <div>
                    <IonText className='ion-padding' color="medium">
                        <small>
                            Hash Dispensa: {receta?.transactionHashDispensa}
                        </small>
                    </IonText>
                </div>) : ''}
